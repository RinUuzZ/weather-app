...
function App() {
  ...
  const search = async () => {
    const element = document.getElementsByClassName('Citty-input');
    if (element[0].value === '') {
      return 0;
    }

    let api_key = 'ebed0757565debac67d07d46ed5239e5';
  ...
  return (
    <div className="container">
      <div className="top-bar">
        <input type="text" className='Citty-input' placeholder='Search' />
      ...
      <div className="data-container">
        <div className="element">
          ...
          <div className="data">
            <div className="humidity-percent">18%</div>
        ...
        <div className="element">
          ...
          <div className="data">
            <div className="wind-rate">64 km/hr</div>
